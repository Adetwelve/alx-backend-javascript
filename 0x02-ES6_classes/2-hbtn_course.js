...
export default class HolbertonCourse {
  ...
  set students(students) {
    if (Array.isArray(students) && students.every((element) => typeof element === 'string')) { this._students = students; } else throw new TypeError('Students must be an array of string');
  }
}
